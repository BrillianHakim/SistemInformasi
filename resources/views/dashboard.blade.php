...
<head>
    ...
    <title>@yield('title') | Si_RumahSakit </title>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">Si_RumahSakit</a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ url('dokter') }}"> <i class="menu-icon fa fa-puzzle-piece"></i>Dokter</a>
                    </li>
                    <li>
                        <a href="{{ url('pasien') }}"> <i class="menu-icon fa fa-puzzle-piece"></i>Pasien</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
